...
//    private JMenuItem exportPaletteMenuItem = new JMenuItem("Export...");  // tpl, c, asm, java?
	...
	private JMenuItem aboutMenuItem = new JMenuItem("About Tile Monster...");
...
///////// Translate items
		...
		aboutMenuItem.setText(xlate("About_Tile_Monster"));
		...
		if (view != null) {
			...
			if (img.getViews().length == 1) {
				...
				if (img.isModified()) {
					...
					xlate("Save_Changes_To")+" "+img.getName()+"?", "Tile Monster",
	...
	public void doSaveAsCommand() {
		...
		if (view != null) {
			...
			if (retVal == JFileChooser.APPROVE_OPTION) {
				...
				doSaveCommand();
				setTitle("Tile Monster - "+view.getTitle());
			}
		}
		setSaveButtonsEnabled(false);
	}
...
**/
	...
	// Show Tip dialog
		JOptionPane.showConfirmDialog(this,
			xlate("Drugs_Message"), "Tile Monster",
...
**/
	...
	// Show About dialog
		JOptionPane.showMessageDialog(this,
			"Tile Monster v 1\nhttps://gitlab.com/jeffalyanak/tile-monster", "Tile Monster",
